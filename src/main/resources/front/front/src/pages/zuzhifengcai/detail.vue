...
<div>
	...
	<div class="detail-preview" :style='{"width":"100%","margin":"0px auto","position":"relative","background":"none"}'>
		...
		<video :style='{"border":"0","padding":"0px 27%","margin":"20px 0 0","outline":"none","borderRadius":"4px","display":"block","width":"100%"}' :src="baseUrl +  detail.shipin" controls="controls">
			您的浏览器不支持视频播放
		</video>
    ...
    methods: {
      ...
      getStoreupStatus(){
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'zuzhifengcai', userid: localStorage.getItem('userid')}}).then(res => {
