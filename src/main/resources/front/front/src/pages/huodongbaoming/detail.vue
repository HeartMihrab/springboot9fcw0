...
<div>
	...
	<div class="detail-preview" :style='{"width":"100%","margin":"0px auto","position":"relative","background":"none"}'>
		<div class="attr" :style='{"padding":"0px","margin":"0 auto","borderRadius":"4px","flexWrap":"wrap","background":"none","display":"flex","width":"85%","position":"relative"}'>
			...
			<div class="info" :style='{"border":"1px solid #eee","padding":"10px","margin":"0 0 0 5%","background":"rgba(255,255,255,.9)","display":"inline-block","width":"45%","minWidth":"540px","order":"2"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>活动主题</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.huodongzhuti}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>志愿者账号</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.zhiyuanzhezhanghao}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>志愿者姓名</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.zhiyuanzhexingming}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>报名时间</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.baomingshijian}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"#c5ddfb","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('huodongbaoming','审核')" @click="onSH" type="warning">审核</el-button>
				</div>
			</div>
		...
		<el-tabs class="detail" :style='{"border":"1px solid #DCDFE6","width":"auto","boxShadow":"0 1px 6px 0 rgba(0, 0, 0, .1)","margin":"40px 7% 0","background":"#fff"}' v-model="activeName" type="border-card">
			<el-tab-pane label="报名理由" name="first">
				<div v-html="detail.baomingliyou"></div>
			</el-tab-pane>
		</el-tabs>
