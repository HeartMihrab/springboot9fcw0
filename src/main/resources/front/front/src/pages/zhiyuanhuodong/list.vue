...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px 7% 0","margin":"0 0 10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
      <el-form-item :style='{"margin":"0 4px 0 0"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>活动主题</div>
        <el-input v-model="formSearch.huodongzhuti" placeholder="活动主题" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 4px 0 0"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>组织名称</div>
        <el-input v-model="formSearch.zuzhimingcheng" placeholder="组织名称" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('zhiyuanhuodong','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"#f8f089","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/zhiyuanhuodongAdd')"><i v-if="true" :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"100%","margin":"40px 0 10px","minWidth":"1050px","background":"none"}'>
		...
		<div class="list1 index-pv1" :style='{"padding":"0px","margin":"0 auto","flexWrap":"wrap","background":"none","display":"flex","width":"85%","justifyContent":"space-between","height":"auto"}'>
			<div :style='{"border":"1px solid #e6e6e6","padding":"10px","margin":"0 0 20px","flexWrap":"wrap","background":"rgba(255,255,255,.8)","display":"flex","width":"23.5%","position":"relative","justifyContent":"space-between","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"width":"100%","boxShadow":"0px 56px 36px -60px #999","objectFit":"cover","borderRadius":"4px","display":"block","height":"275px"}' v-if="item.huodongtupian && item.huodongtupian.substr(0,4)=='http'" :src="item.huodongtupian" class="image" />
				<img :style='{"width":"100%","boxShadow":"0px 56px 36px -60px #999","objectFit":"cover","borderRadius":"4px","display":"block","height":"275px"}' v-else :src="baseUrl + (item.huodongtupian?item.huodongtupian.split(',')[0]:'')" class="image" />
				...
				<div :style='{"padding":"4px 10px","lineHeight":"32px","fontSize":"14px","color":"#3d74c0"}' class="name ">活动主题:{{item.huodongzhuti}}</div>
				<div :style='{"padding":"4px 10px","lineHeight":"32px","fontSize":"14px","color":"#3d74c0"}' class="name ">组织名称:{{item.zuzhimingcheng}}</div>
			</div>
		</div>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.huodongzhuti != '') searchWhere.huodongzhuti = '%' + this.formSearch.huodongzhuti + '%';
