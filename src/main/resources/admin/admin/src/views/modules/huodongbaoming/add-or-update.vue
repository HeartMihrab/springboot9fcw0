	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="活动类型" prop="huodongleixing">
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="报名理由" prop="baomingliyou">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.baomingliyou" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.baomingliyou" label="报名理由" prop="baomingliyou">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#59362f","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.baomingliyou"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.baomingliyou = this.ruleForm.baomingliyou.replace(reg,'../../../springboot9fcw0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
