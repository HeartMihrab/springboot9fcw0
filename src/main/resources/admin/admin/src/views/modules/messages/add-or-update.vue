		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.content" label="留言内容" prop="content">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#59362f","fontWeight":"500","display":"inline-block"}'>{{ruleForm.content}}</span>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.reply" label="回复内容" prop="reply">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#59362f","fontWeight":"500","display":"inline-block"}'>{{ruleForm.reply}}</span>
				</el-form-item>
