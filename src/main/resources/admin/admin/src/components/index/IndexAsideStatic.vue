<template>
	<div class="menu-preview">
		...
		<el-menu
		  :unique-opened="true"
		  :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","background":"rgba(89, 54, 47, 1)","width":"100%","position":"relative"}'
		  default-active="0"
		  class="el-menu-horizontal-demo"
		  mode="horizontal"
		>
		  <el-image v-if="false" :style='{"margin":"8px","objectFit":"cover","borderRadius":"100%","width":"50px","position":"absolute","right":"-5%","float":"right","height":"50px"}' src="http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg" fit="cover"></el-image>
...
<style lang="scss" scoped>
	.menu-preview {
	  ...
	  .el-menu-horizontal-demo .el-submenu /deep/ .el-menu .el-menu-item:hover {
	  		  	padding: 0 40px;
	  		  	color: #fff;
	  		  	background: rgba(179, 124, 113, 0.8);
	  		  	line-height: 50px;
	  		  	height: 50px;
	  		  }
