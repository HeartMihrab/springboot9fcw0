...
public class HuodongleixingController {
    ...
    public R delete(@RequestBody Long[] ids){
        List<HuodongleixingEntity> huodongleixingEntities = huodongleixingService.selectList(new EntityWrapper<HuodongleixingEntity>().in("id", Arrays.asList(ids)));
        for (HuodongleixingEntity huodongleixing : huodongleixingEntities){
            List<ZhiyuanhuodongEntity> zhiyuanhuodongEntities = zhiyuanhuodongService.selectList(new EntityWrapper<ZhiyuanhuodongEntity>().eq("huodongleixing", huodongleixing.getHuodongleixing()));
            for (ZhiyuanhuodongEntity zhiyuanhuodong : zhiyuanhuodongEntities) {
                zhiyuanhuodong.setHuodongleixing("无");
